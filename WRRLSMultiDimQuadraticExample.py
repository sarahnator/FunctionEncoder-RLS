...
parser.add_argument("--n_basis", type=int, default=9)
...
# load_path = 'logs/WRRLS_multi_dim_example/least_squares/shared_model/2025-03-21_14-35-09'
residuals = args.residuals
if load_path is None:
    logdir = f"logs/WRRLS_multi_dim_example/{train_method}/{'shared_model' if not args.parallel else 'parallel_models'}/{datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}"
else:
    logdir = load_path
